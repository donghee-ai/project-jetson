...
> 관련: [speech-stack-research.md](speech-stack-research.md) · [project-candidates.md](project-candidates.md) · [project-proposal.md](project-proposal.md)
...
- [ ] 안 되면: **TTS로 학습 데이터 합성 → 소형 KWS 학습** ([H3](speech-stack-research.md))
